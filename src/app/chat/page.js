  ...
  return (
    <main className={styles.main}>
      <div className={styles.msg}>
        {
          inMsg.map((value, key) => {
            return (<p key={key} style={{ color: 'black', display: 'flex', gap: '1vw', alignItems: 'center', textAlign: {position} }}><FaRegUserCircle size={25} />{value}</p>)
          })
        }
        {/* <p>{typeof(inmsg)}</p> */}
